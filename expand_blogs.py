...
blogs = [
    ...
    },
    {
        ...
        "core": "<p>This philosophy underpins everything we do. Instead of trying to fit you into a pre-existing program, we custom-build our services around your specific aspirations. This might involve blending community engagement with tailored one-on-one therapy. The result is a highly adaptive, deeply respectful approach that leads to far more sustainable outcomes. We invite you to <a href='book-in.html'>book an introductory session</a> to experience firsthand what true person-centered care feels like, and how it can revolutionize your journey toward independence and wellbeing.</p>"
    }
]
